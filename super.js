...
(function () {
  ...
  .sup-app .si{width:48px;height:48px;border-radius:15px;border:1px solid var(--border-hi);background:rgba(10,23,38,.82);color:var(--cyan);display:flex;align-items:center;justify-content:center;box-shadow:0 0 14px rgba(0,212,255,.16);}
